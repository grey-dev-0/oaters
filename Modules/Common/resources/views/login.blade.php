...
<div class="row">
    <div class="col-xs-12 col-sm-10 col-md-5 col-lg-4" id="login">
        <div class="card bg-white border-{{$borderColor}}">
            @if(isset($fail))
            ...
            <div class="card-body">
                <form action="" method="post" enctype="application/x-www-form-urlencoded">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12"><button class="btn btn-block btn-{{$buttonColor}}" type="submit">{{trans('sapphire::admin.login.login')}}</button></div>
                    </div>
                </form>
            </div>
        </div>
