        ...
        <div class="card bg-white border-blue-3">
            @if(isset($fail))
                <div class="alert alert-danger alert-dismissible mb-0">
                    ...
                    {{trans('sapphire::admin.login.invalid_credentials')}}
                </div>
            @endif
            <div class="card-body">
                <form action="" method="post" enctype="application/x-www-form-urlencoded">
                    ...
                    <div class="row">
                        <div class="col-sm-12 form-group"><input type="text" class="form-control" name="{{in_array(request()->segment(1), ['sa', 'st'])? 'email' : 'username'}}" placeholder="{{trans('sapphire::admin.login.username')}}"></div>
